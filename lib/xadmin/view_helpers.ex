defmodule XAdmin.ViewHelpers do
  @moduledoc false
  use Xain
  import XAdmin.Utils
  ...
  @endpoint Application.get_env(:xadmin, :endpoint)
  ...
  def page_title(conn, resource) do
    ...
    case XAdmin.Utils.action_name(conn) do
      :index ->
        plural
      :show ->
        cond do
          ...
          true ->
            XAdmin.Helpers.resource_identity(resource)
        end
