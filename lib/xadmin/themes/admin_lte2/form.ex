defmodule XAdmin.Theme.AdminLte2.Form do
  @moduledoc false
  ...
  def build_actions_block(conn, _model_name, mode) do
    display_name = XAdmin.Utils.displayable_name_singular conn
  ...
  def build_form_error(error) do
    label ".control-label" do
      ...
      text " #{XAdmin.Form.error_messages(error)}"
    end
  end
  ...
  # TODO: Refactor some of this back into XAdmin.Form
