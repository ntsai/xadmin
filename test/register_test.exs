defmodule TestXAdmin.XAdmin.Test do
  use XAdmin.Register
...
defmodule TestXAdmin.XAdmin.Test2 do
  use XAdmin.Register
...
defmodule TestXAdmin.ActionItemWithClear do
  use XAdmin.Register
  register_resource TestXAdmin.Simple do
    clear_action_items!
...
defmodule TestXAdmin.ActionItem do
  use XAdmin.Register
  register_resource TestXAdmin.Simple do
    action_item :index, fn -> :test end
  end
end
defmodule TestXAdmin.DefaultActions do
  use XAdmin.Register
  register_resource TestXAdmin.Simple do
  end
end

defmodule TestXAdmin.MemberCollectionAction do
  use XAdmin.Register
  register_resource TestXAdmin.Simple do
...
defmodule TestXAdmin.RegisterTest do
  use ExUnit.Case, async: true
  alias XAdmin.Register


  setup do
    {:ok, defn: %TestXAdmin.XAdmin.Test{}, defn2: %TestXAdmin.XAdmin.Test2{}}
  end
  ...
  test "default action items" do
    result = %TestXAdmin.DefaultActions{}.actions
  ...
  test "action item with clear" do
    result = %TestXAdmin.ActionItemWithClear{}.actions
    assert Enum.count(result) == 1
    assert {:fn, _, _} = result[:index]
  end
  test "action item" do
    result = %TestXAdmin.ActionItem{}.actions
