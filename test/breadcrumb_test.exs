defmodule XAdmin.BreadCrumbTest do
  use ExUnit.Case, async: true
  alias XAdmin.BreadCrumb
  import Plug.Conn
  alias TestXAdmin.{Simple, ModelDisplayName, DefnDisplayName}
  ...
  def simple_setup(_) do
    ...
    conn = assign(%Plug.Conn{}, :theme, XAdmin.Theme.AdminLte2)
    |> assign(:defn, defn)
  ...
  def model_display_name(_) do
    defn = %TestXAdmin.XAdmin.ModelDisplayName{}
    conn = assign(%Plug.Conn{}, :theme, XAdmin.Theme.AdminLte2)
    |> assign(:defn, defn)
  ...
  def defn_display_name(_) do
    defn = %TestXAdmin.XAdmin.DefnDisplayName{}
    conn = assign(%Plug.Conn{}, :theme, XAdmin.Theme.AdminLte2)
    |> assign(:defn, defn)
