defmodule Mix.Tasks.Admin.Install do
  @moduledoc """
  Install XAdmin supporting files.
  ...
  # @shortdoc "Install XAdmin"

  use Mix.Task
  import Mix.XAdmin.Utils
  ...
  def do_assets(%Config{assets: true, brunch: true} = config) do
    ...
    File.mkdir_p Path.join ~w{web static assets images xadmin datepicker}
    ...
    ++ ~w(xadmin_common.js xadmin_common.js.map)
  ...
  def do_assets(%Config{assets: true} = config) do
    ...
    File.mkdir_p Path.join(~w{priv static images xadmin datepicker})
  ...
  def do_dashboard(%Config{dashboard: true} = config) do
    ...
    |> EEx.eval_file([base: get_module,
      ...
      welcome_txt: (gettext "Welcome to XAdmin. This is the default dashboard page."),
  ...
  def do_assets_instructions(%{assets: true, brunch: true} = config) do
    ...
    Check the bottom of your brunch-config.js file.
      ...
      Instructions for adding the XAdmin assets have been added.
    """
    config
  end
  ...
  def brunch_instructions do
    ...
    // To add the XAdmin generated assets to your brunch build, do the following:
    //
    // Replace
    //
    //     javascripts: {
    ...
    //         "js/xadmin_common.js": ["web/static/vendor/xadmin_common.js"],
